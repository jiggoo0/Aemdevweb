...
export const nakhonSawanNode = defineAreaNode(catalogService, {
  ...
  districts: ["ปากน้ำโพ", "เมืองนครสวรรค์", "ลาดยาว", "ตาคลี", "พยุหะคีรี", "สวรรค์วิถี"],

  // --- Context Data ---
  localContext: {
    marketInsight:
      "คู่ค้าในนครสวรรค์ (โดยเฉพาะย่านปากน้ำโพ) ให้ความสำคัญกับ 'ความมั่นคง' และ 'ราคาที่แข่งขันได้' เว็บไซต์ที่แสดงข้อมูลสินค้าขายส่งชัดเจนและมีหมุดแผนที่แม่นยำจะปิดดีล B2B ได้สูงที่สุด",
    technicalApproach:
