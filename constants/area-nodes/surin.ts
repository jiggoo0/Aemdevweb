...
export const surinNode = defineAreaNode(localAuthorityService, {
  ...
  districts: ["เมืองสุรินทร์", "ท่าตูม", "จอมพระ", "สังขะ", "ปราสาท", "ศรีขรภูมิ", "กาบเชิง"],
  localContext: {
    marketInsight:
      "สุรินทร์มีสินค้าพรีเมียมระดับโลก (ผ้าไหม/ข้าวหอมมะลิ) เว็บไซต์ต้องเน้นความหรูหราและการเล่าเรื่องที่ดูแพง",
    localStrength:
