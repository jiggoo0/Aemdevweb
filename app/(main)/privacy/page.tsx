      ...
      <section className="container mx-auto px-6 py-20">
        <div className="mx-auto max-w-4xl space-y-8">
          <PolicyCard
            ...
            content="ผมให้ความสำคัญกับความเป็นส่วนตัวของคุณมาก ข้อมูลที่น้องกรอกผ่านแบบฟอร์ม เช่น ชื่อ, อีเมล หรือรายละเอียดโปรเจกต์ จะถูกใช้เพื่อวัตถุประสงค์ในการสื่อสารและวางแผนงานร่วมกับพี่เท่านั้น เพื่อให้ระบบงานออกมาตรงใจน้องที่สุดครับ"
          />
            ...
            <div className="relative z-10 flex flex-col items-start gap-8 md:flex-row">
              ...
              <div className="space-y-4">
                ...
                <p className="font-anuphan text-xl leading-relaxed font-bold text-slate-500">
                  หากน้องต้องการตรวจสอบ แก้ไข หรือขอลบข้อมูลส่วนตัวออกจากระบบ
                  ทักมาบอกพี่ได้ทุกเมื่อทาง LINE ID:{" "}
                  <span className="text-emerald-600 underline underline-offset-8">
                    {siteConfig.links?.lineId || "N/A"}
                  </span>{" "}
                  พี่พร้อมจัดการให้ทันทีภายใน 24 ชั่วโมงครับ
                </p>
              </div>
            </div>
          </div>
...
/**
 * ส่วนประกอบย่อย: บัตรข้อมูลนโยบาย
 */
function PolicyCard({
  icon,
  title,
