 ...
 * ยกระดับหน้าผลงานด้วยระบบแสง Aurora และโครงสร้างที่เน้น Speed
 */
export default function UnlinkCaseStudyPage() {
  return (
    <main className="selection:bg-aurora-cyan/30 relative min-h-screen overflow-hidden bg-slate-950 text-slate-50">
      ...
      {/* 🚀 4. BUSINESS RESULTS */}
      <section className="relative border-y border-white/5 bg-white/[0.01] py-32">
