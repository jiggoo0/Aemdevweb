  ...
  return (
    <main className="min-h-screen bg-white selection:bg-blue-600 selection:text-white">
          ...
          {[
            ...
            >
              <div className="space-y-8">
                ...
                <div>
                  <h4 className="mb-3 text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">
                    {item.t}
                  </h4>
              ...
              <div className="mt-12 flex justify-end">
                <ArrowDownRight
                  className="text-slate-200 transition-all duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-blue-600"
                  size={48}
                  strokeWidth={2.5}
                />
              </div>
      ...
      <section className="relative py-32 md:py-48">
        ...
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] bg-[size:2.5rem_2.5rem] opacity-40" />

        <div className="mx-auto max-w-5xl px-6">
          <div className="relative border-2 border-slate-200 bg-white p-8 shadow-sm md:p-24">
            {/* Architectural Corner Mark */}
            <div className="absolute -left-1 -top-1 h-12 w-12 border-l-8 border-t-8 border-blue-600" />
            <div className="absolute -bottom-1 -right-1 h-12 w-12 border-b-8 border-r-8 border-slate-900" />
            ...
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-slate-900 px-6 py-1.5 text-[10px] font-black uppercase tracking-[0.4em] text-white">
              AEMDEVWEB / IDENTITY_V1
            </div>
          </div>
        </div>
      </section>
