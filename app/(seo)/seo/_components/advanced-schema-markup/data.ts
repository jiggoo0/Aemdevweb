...
export const advancedSchemaData: SeoServiceItem = {
  ...
  description:
    "ฝังชุดรหัสระดับเทคนิคเพื่อให้ระบบการค้นหาแสดงผลแบบ Rich Results ช่วยเพิ่มพื้นที่หน้าจอและดึงดูดสายตาผู้ใช้งานบนหน้าผลการค้นหา",
  iconName: "Code2",
  painPoints: [
  ...
  benefits: [
    {
      ...
      desc: "เพิ่มโอกาสที่ผู้ใช้งานจะคลิกเข้าสู่ระบบด้วยการแสดงผลที่โดดเด่น",
    },
    {
      title: "Semantic Clarity",
      desc: "ช่วยให้ระบบการค้นหาเข้าใจความหมายของธุรกิจได้อย่างแม่นยำ 100%",
    },
  ],
  pricing: {
    price: 9900,
  ...
  faq: [
    {
      ...
      answer:
        "ช่วยให้บอทเข้าใจเนื้อหาได้ดีขึ้นและเพิ่มอัตราการคลิก (CTR) ซึ่งเป็นปัจจัยบวกต่อการขยับอันดับครับ",
    },
  ],
}
