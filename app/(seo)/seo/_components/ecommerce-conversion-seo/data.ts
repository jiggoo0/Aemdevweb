...
/**
 * E-commerce Conversion SEO Service Data
 * เน้นการปรับจูนระบบร้านค้าเพื่อเพิ่มยอดขายและประสิทธิภาพการค้นหาสินค้า
 */
export const ecommerceConversionData: SeoServiceItem = {
  id: "seo-ecom-005",
  slug: "ecommerce-conversion-seo",
  title: "E-commerce Conversion SEO",
  subtitle: "ปรับแต่งระบบร้านค้าเพื่อเพิ่มยอดขายและการจัดอันดับสินค้าเชิงพาณิชย์",
  description: "วางโครงสร้างหมวดหมู่และหน้ารายละเอียดสินค้าให้รองรับทั้งระบบการค้นหาและเปลี่ยนผู้เข้าชมให้เป็นลูกค้าด้วยข้อมูลที่แม่นยำ",
  iconName: "BarChart3", 
  ...
  faq: [
    { 
      ...
      answer: "รองรับได้ไม่จำกัดจำนวนรายการครับ ระบบถูกออกแบบมาให้จัดการข้อมูลขนาดใหญ่ได้อย่างเสถียร" 
    }
  ]
}
