...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[oklch(1_0_0)] pt-24 pb-16 dark:bg-[oklch(0.12_0.02_260)] lg:pt-48 lg:pb-40">
        ...
        <div className="flex flex-col items-start gap-16 lg:flex-row lg:items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 rounded-full border border-[oklch(0.65_0.2_160_/_0.2)] bg-[oklch(0.96_0.04_160_/_0.5)] px-5 py-2 shadow-sm backdrop-blur-sm">
              <Terminal size={14} className="animate-pulse text-[oklch(0.5_0.15_160)]" />
            ...
            <div className="relative">
              <h1 className="text-7xl leading-[0.85] font-black tracking-tighter text-[oklch(0.2_0.02_260)] uppercase italic dark:text-[oklch(0.95_0.01_260)] md:text-9xl lg:text-[11rem]">
                <span>AEM</span>
                ...
                <span className="relative mt-4 inline-block text-[0.4em] tracking-tight text-[oklch(0.65_0.2_160)] md:text-[0.5em]">
                  The Specialist<span className="text-[oklch(0.2_0.02_260)] dark:text-[oklch(0.95_0.01_260)]">.</span>
            ...
            <p className="max-w-2xl text-xl leading-relaxed font-bold text-[oklch(0.45_0.02_260)] md:text-2xl">
              ...
              <strong className="text-[oklch(0.2_0.02_260)] dark:text-[oklch(0.95_0.01_260)] underline decoration-[oklch(0.65_0.2_160_/_0.3)] decoration-8 underline-offset-[10px]">
                เว็บไซต์สมรรถนะสูง
              </strong>
            ...
            <div className="flex flex-wrap items-center gap-8 border-t border-[oklch(0.9_0.02_260_/_0.3)] pt-8">
              {[
                ...
                { icon: <CheckCircle size={18} />, text: "พิกัด Linked-Data พร้อมใช้งาน" },
                ...
                >
                  <span className="text-[oklch(0.65_0.2_160)]">{item.icon}</span>
                  {item.text}
                </div>
              ))}
            </div>
              ...
              <div className="depth-card relative overflow-hidden rounded-[3.5rem] bg-white p-12 transition-all duration-700 hover:-translate-y-3 dark:bg-[oklch(0.15_0.02_260)]">
                <div className="space-y-10">
                  ...
                  <div className="space-y-4">
                    <blockquote className="text-4xl leading-[1] font-black text-[oklch(0.2_0.02_260)] dark:text-[oklch(0.95_0.01_260)] italic">
                      เราไม่ได้แค่ทำเว็บ
                      <br />
                      แต่เราวางโครงสร้าง
                      <br />
                  ...
                  <div className="flex items-center gap-5">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[oklch(0.2_0.02_260)] text-white shadow-xl ring-4 ring-[oklch(0.98_0.01_260)] shadow-[oklch(0.2_0.02_260_/_0.2)]">
                      <span className="text-sm font-black italic">AEM</span>
                    </div>
                    <div className="flex flex-col">
                      <div className="text-lg leading-none font-black text-[oklch(0.2_0.02_260)] dark:text-[oklch(0.95_0.01_260)] uppercase italic">
