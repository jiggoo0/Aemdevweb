          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="font-body mb-14 max-w-2xl text-lg leading-relaxed font-bold text-slate-400 md:text-xl">
                นายเอ็มซ่ามากส์ พร้อมเปลี่ยนหน้าเว็บเดิมของ SME
                และกลุ่มธุรกิจของคุณ ให้ก้าวข้ามขีดจำกัดด้วยระบบที่เปิดไว
                งานประณีต คุยตรงไปตรงมา และจบงานได้ตามแผนงานที่วางไว้ครบถ้วนครับ
              </p>
