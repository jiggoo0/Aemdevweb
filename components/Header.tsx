...
export default function Header() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-[90] bg-brand-navy/20 backdrop-blur-sm lg:hidden"
      ...
      >
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="group flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-black uppercase leading-none tracking-tighter text-brand-navy md:text-2xl">
                  {siteConfig.name}
                </span>
                <div className="mt-1 flex items-center gap-1 text-[9px] font-black uppercase tracking-[0.2em] text-brand-blue">
                  <Sparkles size={10} />
            ...
            <div className="hidden items-center gap-4 md:flex">
              <Button
                asChild
                className="group h-12 rounded-none border-2 border-brand-navy bg-brand-navy px-8 text-[11px] font-black uppercase tracking-[0.3em] text-white transition-all hover:bg-brand-blue hover:shadow-enterprise-sm active:scale-95"
              >
          ...
          {/* ─── MOBILE MENU ─── */}
          {isOpen && (
            <div className="absolute left-6 right-6 top-full mt-4 border-2 border-brand-navy bg-white p-4 shadow-enterprise-lg duration-200 animate-in fade-in zoom-in-95 lg:hidden">
                ...
                {siteConfig.navLinks.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      href={link.href}
                      className={cn(
                        "flex items-center justify-between border-2 border-brand-navy p-4 text-sm font-black uppercase tracking-widest transition-all",
                        isActive
              ...
              <div className="mt-6">
                <Button
                  asChild
                  className="h-14 w-full rounded-none border-2 border-brand-navy bg-brand-navy text-[10px] font-black uppercase tracking-[0.3em]"
                >
