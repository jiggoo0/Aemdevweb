  ...
  const values = [
    {
      ...
      description:
        "เลือกใช้ Next.js 15 และเทคโนโลยีล่าสุด เพื่อให้เว็บไซต์ของคุณโหลดไว ปลอดภัย และพร้อมขยายตัวในอนาคต",
    },
    {
      icon: <HeartHandshake className="h-6 w-6 stroke-[1.5]" />,
      title: "คุยง่ายแบบพาร์ทเนอร์",
      description:
        "ผมเชื่อในการสื่อสารที่ตรงไปตรงมา ปรึกษาได้ทุกขั้นตอนเหมือนเพื่อนคู่คิด เน้นช่วยแก้ปัญหาให้ธุรกิจจริง",
    },
    {
      icon: <Lightbulb className="h-6 w-6 stroke-[1.5]" />,
      title: "เน้นผลลัพธ์ที่ใช้งานจริง",
      description:
        "เว็บไซต์ต้องไม่ใช่แค่สวย แต่ต้องเป็นพนักงานขายที่ทำงานได้จริง สร้างความน่าเชื่อถือให้ธุรกิจตลอด 24 ชม.",
    },
  ]
        ...
        <div className="space-y-8 md:space-y-12 lg:col-span-7">
          ...
          <div className="space-y-6 text-base font-bold leading-relaxed text-slate-500 md:text-xl">
            <p>
              ...
              ในโครงสร้างราคาที่โปร่งใส
            </p>

            <p className="font-medium text-slate-600">
              ดูแลงานทุกชิ้นด้วยตัวเองเหมือนงานฝีมือ (Craftsmanship)
              เพื่อให้มั่นใจว่า
              ระบบที่คุณได้รับจะเป็นฟันเฟืองสำคัญในการขับเคลื่อนธุรกิจ...
