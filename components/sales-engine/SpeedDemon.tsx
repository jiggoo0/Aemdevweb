...
export const SpeedDemon = () => {
  ...
  return (
    <section className="bg-background relative overflow-hidden py-32" ref={ref}>
      ...
      <div className="aurora-bg top-1/2 left-1/2 h-[600px] w-[1000px] -translate-x-1/2 -translate-y-1/2 opacity-[0.12]" />
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          <div className="bg-aurora-cyan/5 absolute top-0 right-0 -z-10 h-64 w-64 blur-[80px]" />
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-xs font-black tracking-widest text-slate-500 uppercase">
                <span>เว็บทั่วไป (WordPress Theme)</span>
                <span className="text-rose-500/80">4.5s (ช้าจนลูกค้าหนี)</span>
              </div>
            ...
            {/* AEM Bar */}
            <div className="space-y-3">
              <div className="text-aurora-emerald flex justify-between text-xs font-black tracking-widest uppercase">
                <span className="flex items-center gap-2">
                  AemDevWeb (Next.js 15){" "}
                  <Zap className="h-3 w-3 animate-pulse fill-current" />
                </span>
                <span className="text-white drop-shadow-[0_0_10px_rgba(130,255,180,0.5)]">
                  0.8s (เร็วระดับปีศาจ)
                </span>
              </div>
              <div className="shadow-aurora-glow relative h-6 w-full overflow-hidden rounded-full border border-white/5 bg-white/5">
                ...
                <motion.div
                  ...
                  className="absolute top-0 h-full w-1/4 -skew-x-[30deg] bg-gradient-to-r from-transparent via-white/40 to-transparent"
                />
              </div>
            </div>
          </div>
...
const ScoreCard = ({ metric, isInView }: ScoreCardProps) => {
  return (
    <div className="glass-card group hover:border-aurora-cyan/30 relative flex flex-col items-center justify-center p-10 text-center duration-500 hover:-translate-y-2">
      <div className="aurora-bg top-0 left-0 h-20 w-20 opacity-0 transition-opacity group-hover:opacity-10" />
      ...
      <div className="relative mb-8 h-28 w-28">
        ...
        >
          ...
          <motion.circle
            ...
            transition={{ duration: 2, ease: "circOut", delay: metric.delay }}
          />
        </svg>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <metric.icon className="mt-1 h-3 w-3 text-white/40 transition-colors group-hover:text-white" />
        </div>
      </div>

      <h3 className="text-[10px] font-black tracking-[0.3em] text-slate-500 uppercase transition-colors group-hover:text-white">
        {metric.label}
      </h3>
    </div>
  )
