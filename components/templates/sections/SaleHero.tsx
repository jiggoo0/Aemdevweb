...
export const SaleHero = ({
  ...
  const imgData = image ? IMAGE_BLUR_DATA[image as keyof typeof IMAGE_BLUR_DATA] || null : null;
        ...
        <div className="items-center lg:grid lg:grid-cols-12 lg:gap-16">
          ...
          <div className="relative mt-16 lg:col-span-5 lg:mt-0 xl:col-span-6">
            <div className="relative mx-auto max-w-[500px] lg:max-w-none">
              ...
              <div className="rounded-section relative aspect-square w-full overflow-hidden border border-white/10 bg-white/5 shadow-2xl backdrop-blur-sm">
                {image ? (
                  <Image
                    src={image}
              ...
              <div className="shadow-pro-xl rounded-card absolute -bottom-6 -left-6 hidden items-center gap-4 border border-white/20 bg-white/10 p-5 backdrop-blur-xl md:flex">
                <div
                  style={{
                    backgroundColor: accentColor,
