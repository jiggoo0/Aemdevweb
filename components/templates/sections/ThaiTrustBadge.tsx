/**
 * [COMPONENT]: THAI_TRUST_BADGE v17.9.104 (RSC_ENABLED)
 * [STRATEGY]: Adaptive Theme Architecture | Conversion Psychology | RSC
...
function TrustItem({ icon, title, description, isDark, accentColor }: TrustItemProps) {
  return (
    <div
      className={cn(
        "group rounded-section flex flex-col items-center border p-8 text-center transition-all duration-500",
        isDark
