/**
 * [SECTION COMPONENT]: TECHNICAL_SPEC_SHEET v18.0.3 (SERVER_OPTIMIZED)
 * [STRATEGY]: Pure CSS Transitions | Modal Logic | Zero-Framer
 */
...
export const TechnicalSpecSheet = ({ isOpen, onClose, data }: TechnicalSpecSheetProps) => {
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 z-[100] flex items-center justify-center p-4 transition-all duration-500 md:p-8",
    ...
    >
      ...
      <div
        className={cn(
          "relative flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-[var(--radius)] border-[var(--border-width)] border-[var(--brand-primary)]/30 bg-[var(--surface-main)] shadow-2xl transition-all duration-500",
