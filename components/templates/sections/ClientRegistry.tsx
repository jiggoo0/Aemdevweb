...
const FeatureGrid = memo(({ features }: { features: readonly ServiceFeature[] }) => (
  <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
    {features.map((feature, idx) => (
      ...
      >
        <div className="text-brand-primary border-border bg-surface-offset group-hover:bg-brand-primary group-hover:text-surface-main mb-8 flex h-14 w-14 items-center justify-center rounded-2xl border transition-all duration-500 group-hover:rotate-6">
        ...
        <div className="flex flex-1 flex-col p-6">
          ...
          {item.price && (
            <div className="mt-6 flex justify-center">
              <span className="border-brand-primary/20 bg-brand-primary/5 text-brand-primary rounded-full border px-4 py-1.5 font-mono text-[9px] font-black tracking-widest uppercase">
    ...
    <div className="space-y-24 py-12">
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-6">
            <h2 className="text-text-primary text-3xl font-black tracking-tighter uppercase italic md:text-4xl">
              Success <span className="text-brand-primary">Capabilities.</span>
            </h2>
      ...
      {hasItems && (
        <section className="space-y-12">
          <div className="flex items-center gap-6">
            <h2 className="text-text-primary text-3xl font-black tracking-tighter uppercase italic md:text-4xl">
              Specialized <span className="text-brand-primary">Units.</span>
            </h2>
            <div className="from-brand-primary/30 h-px flex-1 bg-gradient-to-r to-transparent" />
            <span className="text-text-muted font-mono text-[9px] font-black tracking-widest uppercase opacity-30">
              Total: {items!.length}
