/**
 * [SYSTEM COMPONENT]: LAYOUT_ENGINE_V17.0.1 (STABILIZED)
 * [STRATEGY]: Atmospheric Orchestration | Vertical Rhythm | Sticky Footer Logic
...
interface LayoutEngineProps {
  ...
  readonly spacing?: "none" | "small" | "medium" | "large" | "specialist";
}
...
export default function LayoutEngine({
  ...
  const spacingMap = {
    ...
    specialist: "gap-y-52 md:gap-y-72", // เพิ่มความลึกสำหรับหน้า Landing Page ระดับไฮเอนด์
  };
  ...
  return (
    <div className="bg-surface-main relative flex min-h-screen w-full flex-col overflow-x-hidden">
      ...
      >
        ...
        <div className="ambient-aura absolute -top-[10%] -left-[10%] h-[800px] w-[800px] opacity-[0.08] blur-[100px]" />
        <div className="ambient-aura absolute -right-[5%] bottom-[10%] h-[600px] w-[600px] opacity-[0.05] blur-[80px]" />
      ...
      {/* [NOTE]: ใช้ flex-col + gap เพื่อควบคุมระยะห่างระหว่าง Section ได้แม่นยำกว่า space-y */}
      <main
        className={cn(
        ...
        <div className="border-surface-muted flex flex-col items-center justify-between gap-6 border-t border-white/5 pt-8 opacity-40 md:flex-row">
          <div className="flex items-center gap-4">
            ...
            <span className="text-text-muted font-mono text-[9px] font-black tracking-[0.4em] uppercase">
              Engineered_Node v17.0 | 2026.Archive
            </span>
          </div>
