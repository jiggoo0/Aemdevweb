...
export const DirectOrderForm = memo(
  ({ price, unit = "โปรเจกต์", accentColor = "#e11d48" }: DirectOrderFormProps) => {
    ...
    if (isSuccess) {
      return (
        <div className="animate-in fade-in zoom-in shadow-glow rounded-section flex flex-col items-center justify-center border border-white/10 bg-white/5 p-8 text-center backdrop-blur-xl duration-500 md:p-12">
          <div
